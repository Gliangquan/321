    ...
    var PDFViewerApplication = {
      ...
      _readPreferences: function _readPreferences() {
        ...
        return Promise.all([preferences.get('enableWebGL').then(function resolved(value) {
          ...
          viewerPrefs['pdfBugEnabled'] = true || value;
    ...
    var PDFFindController = function () {
      ...
      _createClass(PDFFindController, [{
        ...
        value: function calcFindPhraseMatch(query, pageIndex, pageContent) {
          console.log('calcFindPhraseMatch')
          var matches = [];
  ...
  (function (module, exports, __webpack_require__) {
    ...
    var PDFFindBar = function () {
      ...
      _createClass(PDFFindBar, [{
        ...
        key: 'dispatchEvent',
        value: function dispatchEvent(types, findPrev) {
  ...
  (function (module, exports, __webpack_require__) {
    ...
    var PDFPageView = function () {
      function PDFPageView(options) {
        ...
        // console.log(Math.floor(this.viewport.width))
        ...
        contents.setAttribute('contents-number', this.id);
        contents.id = "contents-" + this.id;
      ...
      _createClass(PDFPageView, [{
        ...
        value: function setPdfPage(pdfPage) {
          ...
          // this.viewport = pdfPage.getViewport(this.scale, totalRotation);
        ...
        value: function draw() {
          ...
          if (this.textLayerFactory) {
            ...
            // 画批注
            var drawLayerDiv = document.createElement('div');
            drawLayerDiv.className = 'drawLayer';
            drawLayerDiv.id = 'drawLayer' + this.id
            drawLayerDiv.style.width = canvasWrapper.style.width;
            drawLayerDiv.style.height = canvasWrapper.style.height;
            drawLayerDiv.style.position = 'absolute'
            drawLayerDiv.style.left = 0
            drawLayerDiv.style.top = 0
            drawLayerDiv.style.right = 0
            drawLayerDiv.style.bottom = 0

            if (this.annotationLayer && this.annotationLayer.div) {
              // var parentDiv = div.parentNode;
              // parentDiv.insertBefore(drawLayerDiv, div);
              div.insertBefore(drawLayerDiv, this.annotationLayer.div);
              div.insertBefore(textLayerDiv, this.annotationLayer.div);
            } else {
              // var parentDiv = div.parentNode;
              // parentDiv.appendChild(drawLayerDiv);
              div.appendChild(drawLayerDiv);
